                                         ...
                                         <div class="tab-pane active" id="profile">
                                             ...
                                             <div class="row">
                                                 <div class="col-md-6" align="left">
                                                     ...
                                                     <p>
                                                        First Name: <?php echo $_SESSION['student']['first_name'];?><BR><BR>
                                                        Last Name: <?php echo $_SESSION['student']['last_name'];?><BR><BR>
                                                        Email: <?php echo $_SESSION['student']['email'];?><BR><BR>
                                                        Contact Number : <?php echo $_SESSION['student']['phone'];?><BR><BR>
                                                        Gender: <?php echo $_SESSION['student']['gender'];?><BR><BR>
                                                        Department: <?php echo $_SESSION['student']['department'];?><BR><BR>
